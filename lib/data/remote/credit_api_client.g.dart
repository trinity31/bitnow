...
part of 'credit_api_client.dart';
...
class _CreditApiClient implements CreditApiClient {
  _CreditApiClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<CreditResponse> getBalance() async {
    ...
    final _options = _setStreamType<CreditResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<MessageResponse> earnCreditFromAd() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
